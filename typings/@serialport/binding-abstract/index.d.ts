declare module '@serialport/binding-abstract' {
  ...
  export default class AbstractBinding extends SerialPort.BaseBinding {
     ...
     * Every flag is set on each call to the provided or default values. All options are always
     * provided.
